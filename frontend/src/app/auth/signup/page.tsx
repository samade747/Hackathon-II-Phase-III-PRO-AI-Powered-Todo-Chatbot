            ...
            >
                <div className="bg-[#1E293B]/60 backdrop-blur-2xl border border-white/5 rounded-[2.5rem] p-10 shadow-3xl shadow-black/50 overflow-hidden relative">
                    ...
                    <div className="flex flex-col items-center mb-10">
                        ...
                        <p className="text-slate-400 text-sm font-medium">Join the intelligent task network</p>
                    </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-[0.2em] text-slate-500 ml-2">Password</label>
                            <div className="relative group">
                                <input
                                    type="password"
                                    required
